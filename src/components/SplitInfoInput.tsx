...
export const SplitInfoInput = ({ ...props }: SplitInfoInputProps) => {
  ...
  return (
    <div>
      ...
      <div className={`ppxiss-input-component ${error ? "ppxiss-input-component-error" : "ppxiss-input-component-ok"} d-flex justify-content-between align-items-center`} style={{ height: "50px", width: "100%", position: "relative" }}>
  <div>
    <div className={"mb-1"}>
